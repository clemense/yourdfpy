...
Welcome to ``yourdfpy`` contributor's guide.
...
If you experience bugs or general issues with ``yourdfpy``, please have a look
...
You can help improve ``yourdfpy`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``yourdfpy`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``yourdfpy``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/yourdfpy.git
    cd yourdfpy
...
#. Install |pre-commit|_::
   ...
   ``yourdfpy`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/yourdfpy
.. _issue tracker: https://github.com/<USERNAME>/yourdfpy/issues
.. <-- end -->
